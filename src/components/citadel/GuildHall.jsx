          ...
          <div className="grid gap-10 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm text-[hsl(0_0%_75%)]">
                <li><a href="#hero" className="transition-colors hover:text-[hsl(43_74%_65%)]">The Grand Exchange</a></li>
                <li><a href="#library" className="transition-colors hover:text-[hsl(43_74%_65%)]">Library of Wisdom</a></li>
                <li><a href="#armory" className="transition-colors hover:text-[hsl(43_74%_65%)]">The Armory</a></li>
              </ul>
            </div>
