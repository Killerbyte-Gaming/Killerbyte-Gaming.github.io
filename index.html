    ...
    <div class="col">
      <div class="h-100 p-0 position-relative" style="background: none !important;">
        <a href="https://youtube.com/{{ video.id }}" target="_blank" rel="noopener noreferrer" class="d-block text-decoration-none h-100">
          <!-- FIXED: Locked into a precise 16:9 widescreen ratio frame -->
          <div style="position: relative; width: 100%; padding-top: 56.25%; border: 1px solid var(--card-border-color) !important; border-radius: 6px; overflow: hidden; background: #000;">
            <img src="https://i.ytimg.com/vi/{{ video.id }}/hqdefault.jpg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; margin: 0; padding: 0;" alt="{{ video.title | escape }}">
          </div>
          <div class="pt-2">
    ...
    <div class="col">
      <div class="h-100 p-0 position-relative" style="background: none !important;">
        <a href="https://youtube.com/{{ short.id }}" target="_blank" rel="noopener noreferrer" class="d-block text-decoration-none h-100">
          <div style="position: relative; width: 100%; padding-top: 177.77%; border: 1px solid var(--card-border-color) !important; border-radius: 6px; overflow: hidden; background: #000;">
...
<!-- FIXED: Injected a structural clearfix block to push the social buttons down -->
<div class="clearfix" style="clear: both !important; height: 20px;"></div>
