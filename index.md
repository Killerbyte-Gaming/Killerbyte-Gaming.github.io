...
<!-- FIXED: Swapped auto-fit out for auto-fill to allow true horizontal centering loops -->
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); justify-content: center; gap: 15px; margin-top: 15px;" markdown="0">
...
<!-- FIXED: Swapped auto-fit to auto-fill for centered mobile clip rows -->
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); justify-content: center; gap: 12px; margin-top: 15px;" markdown="0">
