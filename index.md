    ...
    <div class="col">
      <div class="card h-100 bg-dark text-white border-secondary">
        ...
        <div class="card-body p-2">
          <h6 class="card-title mb-0" style="font-size: 0.9rem; line-height: 1.3;">{{ video.title }}</h6>
        </div>
      </div>
    </div>
  {% endfor %}
  ...
  {% for short in site.data.shorts limit: 4 %}
    <div class="col">
      <div class="card h-100 bg-dark text-white border-secondary">
        ...
        <div class="card-body p-2">
          <h6 class="card-title mb-0" style="font-size: 0.8rem; line-height: 1.3; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">{{ short.title }}</h6>
        </div>
      </div>
    </div>
  {% endfor %}
